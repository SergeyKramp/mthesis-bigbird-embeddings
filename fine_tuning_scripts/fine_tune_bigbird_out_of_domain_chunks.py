...
file_handler = logging.FileHandler('out_of_domain_fine_tuning.log')
...
with open('data/pickled_datasets/seed_42/out_of_domain_test_dataset.pkl', 'wb') as f:
    pickle.dump(test_dataset, f)
    
logger.info('Pickled test dataset')
    
with open('data/pickled_datasets/seed_42/out_of_domain_train_dataset.pkl', 'wb') as f:
...
with open('data/pickled_datasets/seed_42/out_of_domain_fine_tune_dataset.pkl', 'wb') as f:
...
with open('fine_tuned_models/out_of_domain_training_loss.pkl', 'wb') as f:
    pickle.dump(training_loss, f)

with open('fine_tuned_models/out_of_domain_validation_loss.pkl', 'wb') as f:
    pickle.dump(validation_loss, f)

logger.info('Pickled loss values')

# save model and tokenizer
model.save_pretrained('fine_tuned_models/out_of_domain_bigbird_roberta_base')
data_processor.tokenizer.save_pretrained('fine_tuned_models/out_of_domain_bigbird_roberta_base')
