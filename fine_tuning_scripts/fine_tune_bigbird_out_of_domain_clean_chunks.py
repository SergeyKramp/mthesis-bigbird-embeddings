...
file_handler = logging.FileHandler('out_of_domain_fine_tuning_clean.log')
...
train_dataset, test_dataset = data_processor.get_train_test_datasets(split_by_chunks=True, seed=seed, sequence_length=2048, train_size=0.9)
...
logger.info('Split train data to fine-tune and train datasets')

with open('data/pickled_datasets/seed_42/out_of_domain_test_dataset_clean.pkl', 'wb') as f:
    pickle.dump(test_dataset, f)
    
logger.info('Pickled test dataset')
    
with open('data/pickled_datasets/seed_42/out_of_domain_train_dataset_clean.pkl', 'wb') as f:
    pickle.dump(train_dataset, f)
    
logger.info('Pickled train dataset')
...
with open('data/pickled_datasets/seed_42/out_of_domain_fine_tune_dataset_clean.pkl', 'wb') as f:
...
with open('fine_tuned_models/out_of_domain_training_loss_clean.pkl', 'wb') as f:
    pickle.dump(training_loss, f)

with open('fine_tuned_models/out_of_domain_validation_loss_clean.pkl', 'wb') as f:
    pickle.dump(validation_loss, f)

logger.info('Pickled loss values')

# save model and tokenizer
model.save_pretrained('fine_tuned_models/out_of_domain_bigbird_roberta_base_clean')
data_processor.tokenizer.save_pretrained('fine_tuned_models/out_of_domain_bigbird_roberta_base_clean')
