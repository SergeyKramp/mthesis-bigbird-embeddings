...
file_handler = logging.FileHandler('out_of_domain_bert_base_fine_tuning_clean_chunks.log')
...
data_processor = DataProcessor('bert-base-uncased')
...
with open('fine_tuned_models/out_of_domain_bert_base_training_loss_clean_chunks.pkl', 'wb') as f:
    pickle.dump(training_loss, f)

with open('fine_tuned_models/out_of_domain_bert_base_validation_loss_clean_chunks.pkl', 'wb') as f:
    pickle.dump(validation_loss, f)

logger.info('Pickled loss values')

# save model and tokenizer
model.save_pretrained('fine_tuned_models/out_of_domain_bert_base_clean_chunks')
data_processor.tokenizer.save_pretrained('fine_tuned_models/out_of_domain_bert_base_clean_chunks')
